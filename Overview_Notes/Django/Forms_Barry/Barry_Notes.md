...
#### 
###  Asagida tüm form yöntemleri bulunmaktadir. istedigimizi kullanabiliriz.
...
#### Form Save Process
Note: Buradaki islemler, formu manuel olusturdugumuzda takip etmemiz gereken uzun yöntemler. Biz projede hazir form kullandigimiz icin sadece save diyerek kisaca hallettik. 
...
#             student = Student(**student_data)  spread operatörü
...
#### Dosya yüklemeli formlar icin bu daha pratik olacaktir  *****************
...
style.css dosyasi nerede kullanilacak ise orada cagirilir. 
kullanilacagi sayfanin en basinda load static demeyi unutmuyoruz.
...
### Önemli:  
crispy kullanabilmek icin bootstrap in linklerini base.html e yüklememiz gerekir.
...
```html
## load static ifadesi base.html de bulundugu icin asagidaki kodu yazariz.
...
## 
number field larda dajngo default olarak sadece sayi girilip girilmediginin kontrolünü yapiyor. ger özel bir sayi araliginda giris olsun istersek custom validation yazmak zorundayiz.
