...
- TemplateView
  ...
  - Using TemplateView in views.py
    (Burada class based view kullanma maksadi su:  home.html gibi bir template i göstermek. Tabi ki burada func based de kullanilabilir ama class based cok daha efectiv)

- Generic display views
  - ListView (e-ticaret sitesinde ürün listelerinde class based kullanim)
  - DetailView (ürüne tiklandiginda details de kullanma )
...
-- auth islemleri icin class based kullanimi

-- Docs da daha farkli view lar var bakalim
...
(view lar response olarak xml, foto video ve hersey dönebilir.)

These allow you to structure your views and reuse code by harnessing inheritance and mixins. (Mixin ayni anda bircok class dan inheritance yapmaktir)

Class-based views provide an alternative way to implement views as Python objects instead of functions. They do not replace function-based views, but have certain differences and advantages when compared to function-based views:
(Sınıf tabanlı görünümler, görünümleri işlevler yerine Python nesneleri olarak uygulamak için alternatif bir yol sağlar. İşlev tabanlı görünümlerin yerini almazlar, ancak işlev tabanlı görünümlerle karşılaştırıldığında belirli farklılıkları ve avantajları vardır:)

(clas based kullanimi icin biraz daha fazla bilgiye ihtiyacimiz var. Cünkü class in attributelarini ve yapisini bilmemiz gerekir. ama func based de tamamen inisiyatif bizde. kodlari sifirdan yaziyoruz.)

(eger yazacagimiz kodlar default ile benzerse bu durumda class based kullanilir ve miras alinir önce yapilan islemlerden)

- Organization of code related to specific HTTP methods (GET, POST, etc.) can be addressed by separate methods instead of conditional branching.

- Object oriented techniques such as mixins (multiple inheritance) can be used to factor code into reusable components. (Karıştırma (çoklu kalıtım) gibi nesne yönelimli teknikler, kodu yeniden kullanılabilir bileşenlere dönüştürmek için kullanılabilir.)
...
### python-decouple
Kullanim amaci: secret key imizin bilinmesi demek server imiza ulasilmasi ve tüm bilgilerimizin alinmasi demek
...
## TemplateView
- Bu bizim herhangi bir template imizi görüntülemek icin kullandigiiz class based bir view dir
